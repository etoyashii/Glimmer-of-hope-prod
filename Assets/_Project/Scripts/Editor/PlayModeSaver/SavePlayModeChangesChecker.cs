...
using static GlimmerOfHope.Editor.PlayModeSaver.SerializedSelection;
...
{ 
	...
	public static class SavePlayModeChangesChecker {
        ...
        static void OnChangePlayModeState (PlayModeStateChange state) {
		...
		static GameObject[] GetGameObjectsToPersist () {
			var persist = Object.FindObjectsByType<SavePlayModeChanges>(FindObjectsSortMode.None);
		...
		static void Load () {
			...
			var serializedData = new SerializedSelection();
